...
class DataBatch(tf.keras.utils.Sequence):
    ...
    def __init__(self, DataInp, BatchSize, shuffle = False, outptype = 2, *args, **kwargs):
        ...
        '''
        outptype
        0 : (OutpData, OutpData_diff)               # DI-A or DA-A
        1 : (OutpData, OutAmplitude)                # DI-D or DA-D
        2 : (OutpData, OutpData_diff, OutAmplitude) # DI or DA
        '''
